...
class GLViewWidget(QtWidgets.QOpenGLWidget):
    ...
    def __init__(self, parent=None, devicePixelRatio=None, rotationMethod='euler'):
        ...
        **Arguments:**
        ...
        self.opts = {
            ...
            'distance': 0,         ## distance of camera from center
    ...
    def reset(self):
        ...
        self.opts['elevation'] = 0          ## camera's angle of elevation in degrees
        self.opts['azimuth'] = 0            ## camera's azimuthal angle in degrees 
                                             ## (rotation around z-axis 0 points along x-axis)
        self.opts['viewport'] = None         ## glViewport params; None == whole widget
        self.setBackgroundColor('k')        

    def eyeRotation(self,azi,ele):
        self.opts['azimuth'] = azi            ## camera's azimuthal angle in degrees       
        self.opts['elevation'] = ele          ## camera's angle of elevation in degrees        
        self.update()
